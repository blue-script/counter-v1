...
export const Counter: React.FC = () => {
  ...
  return (
    <S.Counter>
      <S.DisplayScore $value={value} $maxvalue={rangeValues.maxValue}
                      $iscorrectvalues={valueStates.isCorrectValues.toString()}
                      $issetvalue={valueStates.isSetValues.toString()}>
        {
